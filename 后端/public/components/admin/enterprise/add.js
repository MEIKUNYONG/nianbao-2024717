				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="企业名称" prop="enterprise_name">
							<el-input  v-model="form.enterprise_name" autoComplete="off" clearable  placeholder="请输入企业名称"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row >
					<el-col :span="24">
						<el-form-item label="信用代码" prop="enterprise_code">
							<el-input  v-model="form.enterprise_code" autoComplete="off" clearable  placeholder="请输入信用代码"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row >
					<el-col :span="24">
						<el-form-item label="法人代表" prop="legal_person">
							<el-input  v-model="form.legal_person" autoComplete="off" clearable  placeholder="请输入法人代表"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row >
	...
	methods: {
		...
		submit(){
			this.$refs['form'].validate(valid => {
				if(valid) {
					this.loading = true
					axios.post(base_url + '/Enterprise/add',this.form).then(res => {
