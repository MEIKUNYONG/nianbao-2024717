<?php /*a:2:{s:55:"/www/wwwroot/nianbao/app/admin/view/member/binding.html";i:1688114739;s:57:"/www/wwwroot/nianbao/app/admin/view/common/container.html";i:1693629258;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
new Vue({
	...
	methods:{
		index(){
			...
			this.loading = true
			axios.post(base_url + '/Member/binding',param).then(res => {
				if(res.data.status == 200){
